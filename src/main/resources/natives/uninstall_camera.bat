...
if errorlevel 1 (
    mshta vbscript:msgbox("This script requires PowerShell, which was not found on PATH. Please install PowerShell to uninstall the virtual camera.",16,"Minecraft Virtualcam")(window.close)
    exit /b 1
)
